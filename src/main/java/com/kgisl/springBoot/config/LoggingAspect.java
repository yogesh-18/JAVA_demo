package com.kgisl.springBoot.config;
...
public class LoggingAspect {
    ...
    @Before(value = "execution(* com.kgisl.springBoot.service.PersonService.*(..))")
    ...
    @After(value = "execution(* com.kgisl.springBoot.service.PersonService.*(..))")
